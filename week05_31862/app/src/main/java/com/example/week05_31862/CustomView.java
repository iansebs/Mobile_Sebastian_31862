package com.example.week05_31862;
...
public class CustomView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (bentuk.equalsIgnoreCase("Rect")) {
            canvas.drawRect(awwalX, awalY, antarX, antarY, paintKu);
        } else if (bentuk.equalsIgnoreCase("Oval")) {
            canvas.drawOval(awwalX, awalY, antarX, antarY, paintKu);
        } else if (bentuk.equalsIgnoreCase("Line")) {
            canvas.drawLine(awwalX, awalY, antarX, antarY, paintKu);
        }
    }}
    ...
    private void lepas(){
        ...
        if (bentuk.equalsIgnoreCase("Path")){
            ...
            kanvasKu.drawRect(awwalX, awalY, antarX, antarY, paintKu);
        } else if (bentuk.equalsIgnoreCase("Oval")){
            kanvasKu.drawOval(awwalX, awalY, antarX, antarY, paintKu);
        }else if (bentuk.equalsIgnoreCase("Line")){
            kanvasKu.drawLine(awwalX, awalY, antarX, antarY, paintKu);
        }
    }}
