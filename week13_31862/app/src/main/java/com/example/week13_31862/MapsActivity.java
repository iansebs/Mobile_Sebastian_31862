package com.example.week13_31862;
...
public class MapsActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftarMarkerDanShape.add(new MarkerDanShape("Marker",
                "Universitas Multimedia Nusantara", 0.0,lokalTitiks));
        daftarMarkerDanShape.add(new MarkerDanShape("Circle",
                "Area 500 m dari UMN",500.0, lokalTitiks));
        lokalTitiks.clear();
        ...
        daftarMarkerDanShape.add(new MarkerDanShape("PolyLine",
                "Jalur UMN ke Bethsaida",0.0, lokalTitiks));
        lokalTitiks.clear();
        ...
        daftarMarkerDanShape.add(new MarkerDanShape("Polygon",
                "Area Kampus UMN",0.0, lokalTitiks));
        lokalTitiks.clear();
    }
